...
<section class="content">
    ...
    <?php echo form_open($url . '/paket', 'id="form-paket"'); ?>
    <input type="hidden" name="paket_topik-id" id="paket_topik-id">
    <input type="hidden" name="paket_paket-id" id="paket_paket-id">
    <input type="hidden" name="paket_pilihan" id="paket_pilihan">
    </form>
...
<script lang="javascript">
    ...
    function paket($pilihan, $topik_id, $paket_id) {
        $('#paket_topik-id').val($topik_id);
        $('#paket_paket-id').val($paket_id);
        $('#paket_pilihan').val($pilihan);
