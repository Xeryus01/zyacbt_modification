                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="hidden" name="tambah-paket-id" id="tambah-paket-id">
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            ...
                                                            <input type="hidden" id="image-paket-id" name="image-paket-id">
...
<script lang="javascript">
    ...
    function refresh_topik() {
        ...
        var paket = $('#paket').val();
        string = judul + " - Paket " + paket;
        $('#judul-daftar-soal').html(string);
        $('#judul-tambah-soal').html(string);
    }
    ...
    function edit(id) {
        ...
        $.getJSON('<?php echo site_url() . '/' . $url; ?>/get_by_id/' + id + '', function(data) {
            if (data.data == 1) {
                ...
                $('#tambah-paket-id').val(data.id_paket);
