                    ...
                    <div class="row-fluid">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="tambah-phone" name="tambah-phone" placeholder="No Telepon Peserta">
                            </div>

                            <div class="form-group">
                                <label>Asal SMA</label>
                                <input type="text" class="form-control" id="tambah-sma" name="tambah-sma" placeholder="Asal SMA Peserta">
                            </div>

                            <div class="form-group">
                                <label>Alamat</label>
                                <input type="text" class="form-control" id="tambah-address" name="tambah-address" placeholder="Alamat Peserta">
                            </div>

                            <!-- <div class="form-group">
                                <label>Status Peserta</label>
                                <input type="text" class="form-control" id="tambah-phone" name="tambah-phone" placeholder="No. HP Peserta">
                            </div> -->
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    <div class="row-fluid">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label>No Telepon</label>
                                <input type="text" class="form-control" id="edit-phone" name="edit-phone" placeholder="No Telepon Peserta">
                            </div>

                            <div class="form-group">
                                <label>Asal SMA</label>
                                <input type="text" class="form-control" id="edit-sma" name="edit-sma" placeholder="Asal SMA Peserta">
                            </div>

                            <div class="form-group">
                                <label>Alamat</label>
                                <input type="text" class="form-control" id="edit-address" name="edit-address" placeholder="Alamat Peserta">
                            </div>

                            <!-- <div class="form-group">
                                <label>Status Peserta</label>
                                <input type="text" class="form-control" id="edit-phone" name="edit-phone" placeholder="No. HP Peserta">
                            </div> -->
    ...
    function edit(id) {
        ...
        $.getJSON('<?php echo site_url() . '/' . $url; ?>/get_by_id/' + id + '', function(data) {
            if (data.data == 1) {
                ...
                $('#edit-sma').val(data.sma);
                $('#edit-address').val(data.address);
                // $('#edit-userstatus').val(data.status);
