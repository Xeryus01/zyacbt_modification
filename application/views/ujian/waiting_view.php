                    ...
                    <div class="panel-heading">
                        <div class="panel-title">
                            ...
                            <div>
                                ...
                                <a style="color:#F8F8FF;" href="https://api.whatsapp.com/send?phone=6281332311261&text=<?= $text; ?>" target="_blank"><img src="<?php echo base_url(); ?>wa.png" class="rounded" width="30px" height="30px"> WhatsApp Admin</a>
                            </div>
                        </div>
                    </div>
                </div>
